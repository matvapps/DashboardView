...
public class CustomTachometer extends Tachometer {
    ...
    public CustomTachometer(Context context) {
        this(context, null);
    }

    public CustomTachometer(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomTachometer(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        speedometerPaint.setStrokeCap(Paint.Cap.ROUND);
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        ...
        float risk3 = getSpeedometerWidth() * 1.38f;
    ...
    private void initDraw() {
        ...
        speedometerTopArcPaint.setStrokeWidth(getSpeedometerWidth() * 0.35f);
